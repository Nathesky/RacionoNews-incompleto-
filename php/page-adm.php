        ...
        <aside class="sidebar" >
            ...
            <nav class="menuNav">
                <ul id="menuOptions">
                    ...
                    <li><a href="registro-gerente.php">Cadastrar Gerente</a></li>
                    <li><a href="liberar-user.php">Liberar Usuários</a></li>
                    <li><a href="liberar-jornalist.php">Liberar Jornalistas</a></li>
                </ul>
            </nav>
        </div>
        </aside>
